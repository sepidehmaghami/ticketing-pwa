              ...
              <Row gutter={32}>
                <Col span={6}>
                  <Card
                    ...
                    cover={
                      <img
                        alt="Parham Heidari"
                        src="https://www.chat.arashweb.com/avatar/parham"
                      />
                    }
                  >
                    <h6>
                      <a href={"./profile"}>Parham Heidari</a>
                    </h6>
                    <FileTextOutlined style={{ padding: "1px 6px 4px 0px" }} />
                    Email :{" "}
                    <Paragraph copyable>heidari1377@gmail.com</Paragraph>
                    <PhoneOutlined style={{ padding: "1px 6px 4px 0px" }} />
                    Phone Number :{" "}
                    <Paragraph copyable>+98 (513) 848-2949</Paragraph>
                    <SendOutlined style={{ padding: "1px 6px 4px 0px" }} />
                    Telegram : <Paragraph copyable>@parhamheidari</Paragraph>
                ...
                <Col span={6}>
                  ...
                  >
                    ...
                    <SendOutlined style={{ padding: "1px 6px 4px 0px" }} />
                    Telegram : <Paragraph copyable>@M_Ansari_Astaneh</Paragraph>
                ...
                <Col span={6}>
                  <Card
                    ...
                    cover={
                      <img
                        alt="Ata Attarian"
                        src="https://www.chat.arashweb.com/avatar/ataattarian"
                      />
                    }
                  >
                    <h6>
                      <a href={"./profile"}>Ata Attarian</a>
                    </h6>
                    <FileTextOutlined style={{ padding: "1px 6px 4px 0px" }} />
                    Email :{" "}
                    <Paragraph copyable>ata.attarian78@gmail.com</Paragraph>
                    <PhoneOutlined style={{ padding: "1px 6px 4px 0px" }} />
                    Phone Number :{" "}
                    <Paragraph copyable>+98 (915) 715-3194</Paragraph>
                    <SendOutlined style={{ padding: "1px 6px 4px 0px" }} />
                    Telegram : <Paragraph copyable>@atta_attarian</Paragraph>
                ...
                <Col span={6}>
                  ...
                  >
                    ...
                    <SendOutlined style={{ padding: "1px 6px 4px 0px" }} />
                    Telegram : <Paragraph copyable>@S_darban_maghami</Paragraph>
